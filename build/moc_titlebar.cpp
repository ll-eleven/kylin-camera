...
QT_MOC_LITERAL(1, 9, 16), // "iconButtonSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "MaxBtn_change"
QT_MOC_LITERAL(4, 41, 5), // "close"
QT_MOC_LITERAL(5, 47, 9) // "onClicked"

    },
    "TitleBar\0iconButtonSignal\0\0MaxBtn_change\0"
    "close\0onClicked"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->iconButtonSignal(); break;
        case 1: _t->MaxBtn_change(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::iconButtonSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::MaxBtn_change)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::close)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void TitleBar::iconButtonSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TitleBar::MaxBtn_change()
{
