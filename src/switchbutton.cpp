...
void SwitchButton::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawEllipse(QRectF(m_nX - (m_nHeight / 2), m_nY - (m_nHeight / 2), height() - 2 * m_nMargin, height() - 2 * m_nMargin));
//    qDebug() << height();
}
...
{
//    return QSize((m_nHeight + m_nMargin), m_nHeight + 2 * m_nMargin);
  return QSize(16,16);
}
